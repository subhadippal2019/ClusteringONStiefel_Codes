...
#   
  ...
  curr_param=list(M,D,V,delta)
  names(curr_param)=c("M","D","V", "id_arr")
  # number of classes
  nc = inc; 
  ...
  for (iter in 1:maxiter) 
  {
    ...
    #Suppress this loop  to fix theta
      if(iter == 1){
        init_param = init_param_from_MLE(y,nc)
      ...
      #print_debug(,hyper$debug)
      
    	curr_param = cluster_param_update(y, curr_param, delta, cluster_id_vec=1:nc,hyper) 
      M=curr_param$M
      D=curr_param$D
      V=curr_param$V
